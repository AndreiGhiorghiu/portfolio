...
import { RawCondition, Dict, UtilityConfig, PropertyConfig, PatternHelpers, CascadeLayers, RecipeConfig, SlotRecipeConfig, CssKeyframes, Token, ArtifactFilters, StaticCssOptions, SystemStyleObject } from '@pandacss/types';
...
declare class Recipes {
    ...
    get keys(): string[];
    constructor(recipes: RecipeRecord, context: StylesheetContext);
    private getPropKey;
...
export { AtomicRule, Breakpoints, Conditions, RecipeNode, Recipes, Stylesheet, StylesheetContext, StylesheetOptions, TransformResult, Utility, assignCompositions, expandCssFunctions, expandNestedCss, extractParentSelectors, getStaticCss, isSlotRecipe, mergeCss, optimizeCss, prettifyCss, sharedHooks, toCss, toKeyframeCss };
